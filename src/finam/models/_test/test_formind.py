...
class TestAdapter(unittest.TestCase):
    def test_reduction_factor(self):
        ...
        self.source = CallbackGenerator(callbacks={"SW": lambda t: values[t]}, step=1)
        ...
        self.assertEqual(self.adapter.get_data(0), 0.0)
        ...
        self.assertEqual(self.adapter.get_data(0), 0.5)
