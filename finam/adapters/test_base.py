...
from .base import Callback, GridCallback, GridToValue, ValueToGrid
...
class TestGridCallback(unittest.TestCase):
    def setUp(self):
        ...
        self.adapter = GridCallback(callback=lambda x, y, v, t: v + t + x)
...
class TestGridToValue(unittest.TestCase):
    ...
    def test_matrix_to_value_mean(self):
    ...
    def test_matrix_to_value_sum(self):
